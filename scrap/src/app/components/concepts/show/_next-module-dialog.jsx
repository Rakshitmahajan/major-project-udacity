...
var mapStateToProps = (state, ownProps) => ({
  lesson: _.first(StateHelper.getLessonsByModuleKey(state, ownProps.module.key))
});
...
export default connect(mapStateToProps)(
  createReactClass({
    ...
    render() {
      var {isOpen, onRequestClose, module, lesson, currentLesson} = this.props;
      ...
      return lesson ? (
        <NextDialog
          ...
          button={{
            ...
            url: this.lastViewedConceptPath({

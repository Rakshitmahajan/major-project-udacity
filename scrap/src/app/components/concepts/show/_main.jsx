...
export const Main = createReactClass({
  ...
  render() {
    ...
    var updatedAtoms = this._returnAtomWithInstructorNotes(atoms);

    const atomRequiresWideLayout = this._atomRequiresWideLayout(updatedAtoms);
    var isAutoAdvanceable = this._isAutoAdvanceable(updatedAtoms);
    ...
    return (
      ...
      >
        <div styleName="content-container">
            ...
            const currentAtomContainer = (
              <AtomContainer
                ...
                onToggleFullScreen={
                  isFullScreen
                    ? undefined
                    : () => this.toggleMaximizeAtom(atom.key)
                }
          ...
          {NodeHelper.isResourcesEmpty(concept.resources) ? null : (
            <div
              styleName={
                isWideLayout

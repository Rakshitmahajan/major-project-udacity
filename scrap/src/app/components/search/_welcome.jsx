...
export default class Welcome extends React.Component {
  ...
  _renderWelcomeMessage() {
    return (
      <div>
        <h3>{__('Welcome to search')}</h3>
        <p>
          {__(
            'Look through concepts, quizzes, videos, and images of this Nanodegree program for the information you need.'
          )}
        </p>
      </div>
    );
      ...
      <div styleName="welcome">
        ...
        <KnowledgePlaceholder root={nanodegree} placeholder={null}>
          <div styleName="question">
            <h6>{__('Have questions and looking for answers?')}</h6>
            <p>
              {__(

...
function getErrorMessage(partLockReason) {
  switch (partLockReason) {
    ...
    case PartLockedReason.SPECIALIZATION_NOT_CHOSEN:
      return __('This content is not in a specialization you have chosen');
    ...
    case PartLockedReason.OUTSIDE_FREE_PREVIEW:
      return __('This content is not a part of your free preview.');
    case PartLockedReason.EXPIRED_FREE_PREVIEW:
      return __('This free preview content has expired.');

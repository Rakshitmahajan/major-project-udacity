    ...
    case Actions.Types.UPDATE_NOTIFICATION_PREFERENCES_COMPLETED: {
      return _.reduce(
        ...
        (state, category) => {
          ...
          return idx >= 0 ? update(state, {$splice: [[idx, 1]]}) : state;
        },
        state
      );
    }
...
export default combineReducers({
  ...
  isFetchingCareerServices: createProcessReducer(
    Actions.Types.FETCH_CAREER_SERVICES,
    Actions.Types.FETCH_CAREER_SERVICES_COMPLETED
  ),

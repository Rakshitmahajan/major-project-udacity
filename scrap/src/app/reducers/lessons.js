...
export default function(state = {}, action) {
  ...
  switch (action.type) {
    ...
    case Actions.Types.FETCH_ME_COMPLETED:
      const {nanodegrees, courses} = action.payload;
    ...
    case Actions.Types.FETCH_LAB_COMPLETED:
      ...
      state = updateLessons(state, [{...lessonWithLab, lab}]);
      break;
    ...
    case Actions.Types.UPDATE_CONCEPT_COUNTS:
      const {lessonKey, conceptKey, lastViewedAt, increment} = action.payload;
      ...
      if (lesson) {
        ...
        state = {...state, [lessonKey]: updatedLesson};
      }
      break;
  }

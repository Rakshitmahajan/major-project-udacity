...
class Topbar extends Component {
  ...
  render() {
    return (
      <div class="navHeaderLarge_nav-header-large__2H1SD">
        <div class="contentWrapper_content-wrapper__19WZ6">
          <div class="navHeaderLarge_logo-nav-wrapper__3QkHM">
            <a href="/" target="_self">
              <h1 class="logo_logo__1dKpD">Knowledge</h1>
            </a>
            <nav class="navList_nav-list__3K434">
              <h6 class="vds-heading--h6 vds-spacing--stack-none">
                <div class="navListItem_nav-list-item__3kek6">
                  <a href="/questions/new">
                    <i class="vds-icon vds-color--white" role="img" aria-hidden="true">
                    ...
                    </i><span class="navListItem_text__EpA3h">post</span>
                  </a>
                </div>
              </h6>
              <h6 class="vds-heading--h6 vds-spacing--stack-none">
                <div class="navListItem_nav-list-item__3kek6">
                  <a href="/activity/questions">
                    <i class="vds-icon vds-color--white" role="img" aria-hidden="true">
                    ...
                    </i><span class="navListItem_text__EpA3h">activity</span>
                  </a>
                </div>
              </h6>
            </nav>
          </div>
          <div class="navHeaderLarge_input-grid__kp7aY">
            <form class="searchInput_search-form__18qR1">
              <input data-ref="search-input" name="textInputValue" type="text" placeholder="Search for your question…" class="searchInput_search-input__my9vq" autocomplete="off" value="" />
              <button class="searchInput_search-button__1Pl3G" data-ref="search-button" type="submit">
                <i class="vds-icon vds-color--cerulean" role="img" aria-hidden="true">
            ...
            <div class="navHeaderLarge_search-filter-toggle__2y5Mt">
              <button class="searchFilterToggle_filter-toggle__1kEOX">

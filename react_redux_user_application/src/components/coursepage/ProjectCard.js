        ...
        return (
            <div className="">
                <Link className='col-sm-12 text-decoration-none' to='/lesson' onClick={this.lessonFunction}>
                    <div><div className="index--lesson-card--mwX1V index--card-interactive--1EHiQ shared--card-interactive--2Jtvl shared--card--3X88h"><a className="index--curtain--3sKxm shared--curtain--2_FSP" href="/courses/ud839/lessons/6745394898239847/concepts/last-viewed">Continue</a><div className="index--container--1pEmR"><span id="lesson-card-scroll-target-6745394898239847" className="index--scroll-target--kzi6f"></span><div className="_lesson-expanded--lesson-expanded-project--1Mc1u _lesson-expanded--_lesson-expanded--12yZy">

...
class LessonCard extends React.Component {
  render() {
    return (
      <div className="">
        <Link className='col-sm-12 text-decoration-none' to={{ pathname: "/course/" + this.props.lesson.courseId + "/" + this.props.lesson.lessonId, state: { lesson: this.props.lesson } }}>
          <div>
            <div
              className="index--lesson-card--mwX1V index--card-interactive--1EHiQ shared--card-interactive--2Jtvl shared--card--3X88h text-decoration-none">
                    ...
                    <div className="_lesson-expanded--text--1jM3p">
                      <div className="_lesson-expanded--header--rATlm">
                        <div className="_lesson-expanded--tag-container--Fn1Eu">
                          <h5 className="_lesson-expanded--tag--Dx7Iu shared--header-meta--19afO text-decoration-none">
                            lesson {this.props.lesson.lessonNumber}</h5>
                        </div>

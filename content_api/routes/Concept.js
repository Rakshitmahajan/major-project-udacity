...
app.get('/:courseId/:lessonId', async (req, res) => {
  // const result = await pool.readConceptData(req.params.courseId, req.params.lessonId,req.params.conceptTitle);
  const result = await pool.readConceptData(req.params.courseId, req.params.lessonId);
  res.json(result);
})
